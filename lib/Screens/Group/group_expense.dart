...
import 'Group_Expense_Pages/group_balances.dart';
import 'Group_Expense_Pages/group_settleup.dart';
import 'Group_Expense_Pages/group_total_balance.dart';
            ...
            setState(() {
              ...
              if (selectedIndex != 0) {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => choiceChipPages[selectedIndex - 1],
                  ),
                );
              }
            });
