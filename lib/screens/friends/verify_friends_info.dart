...
class _VerifyFriendsInfoState extends State<VerifyFriendsInfo> {
  ...
  Contact getPhoneDetails(int index) {
    return widget.selectedName[index];
  }
                ...
                return Column(
                  children: [
                    Row(
                      children: [
                        CircleAvatar(
                          child: Text(getPhoneDetails(index).displayName![0]),
                        ),
                        const SizedBox(
                          width: 20,
                        ),
                        Column(
                          ...
                          children: [
                            Text(
                              getPhoneDetails(index).displayName!,
                              style: themeData.textTheme.bodySmall!.copyWith(
                                color: CommonColors.whiteColor,
                              ),
                            ),
                            Text(
                              getPhoneDetails(index)
                                  .phones![0]
                                  .value
                                  .toString(),
                              style: themeData.textTheme.bodySmall!.copyWith(
